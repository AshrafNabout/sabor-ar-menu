...
Five self-contained GLB and USDZ assets are hosted in this repository: burger, pasta, shrimp, salmon and dessert. The current assets are tabletop photo plaques generated by `generate_photo_ar.py`, embedding the same dish imagery shown by the menu. No expiring asset links are used. These are visual menu previews, not photogrammetric scans or a real ordering system.
